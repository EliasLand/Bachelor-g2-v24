...
class ArUcoDetectorNode(Node):
    def __init__(self):
        ...
        self.arucoDict = aruco.Dictionary_get(ARUCO_DICT["DICT_4X4_100"])
    ...
    def detect_and_publish(self):
        ...
        if ret:
            corners, ids, rejectedImgPoints = aruco.detectMarkers(frame, self.arucoDict, parameters=self.arucoParams)
            if ids is not None:
                max_x = None
                best_marker = None
